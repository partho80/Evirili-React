...
function BlogBody() {
  return (
      <div>
          <section className="main-blog-page-section section-top-padding">
						...
						<div className="row">
								...
								<div className="blog-box">
									...
									<div className="bb-text">
										<a href="blog-details.html">
											<h2>If I have free time, I want to go
												the beach shopping mall.</h2>
										</a>
										<p>Lorem Ipsum available, but the majority have
											suffered alteration in some form, by injected
											randomised words which even.</p>
							...
							<div className="col-md-6 col-12 col-sm-6">
								<div className="blog-box">
									...
									<div className="bb-text">
										<a href="blog-details.html">
											<h2>Shopping at any level is a bit
												therapy for my medulla.</h2>
										</a>
										<p>Lorem Ipsum available, but the majority have
											suffered alteration in some form, by injected
											randomised words which even.</p>
							...
							<div className="col-md-6 col-12 col-sm-6">
								<div className="blog-box">
									...
									<div className="bb-text">
										<a href="blog-details.html">
											<h2>My shopping habits, I am not
												very brand-conscious..</h2>
										</a>
										<p>Lorem Ipsum available, but the majority have
											suffered alteration in some form, by injected
											randomised words which even.</p>
							...
							<div className="col-md-6 col-12 col-sm-6">
								<div className="blog-box">
									...
									<div className="bb-text">
										<a href="blog-details.html">
											<h2>I have a Samurai on my left
												subconscious level.</h2>
										</a>
										<p>Lorem Ipsum available, but the majority have
											suffered alteration in some form, by injected
											randomised words which even.</p>
							...
							<div className="col-md-6 col-12 col-sm-6">
								<div className="blog-box">
									<div className="bb-img">
										<img src="assets/img/Blog/blog-img-5.png" alt="" />
										<div className="bb-img-rapper-info">
											<div className="bb date">
												<p>24 August 2019</p>
											</div>
									...
									<div className="bb-text">
										<a href="blog-details.html">
											<h2>Love yourself for who you are
												and trust me, if you are happy.</h2>
										</a>
										<p>Lorem Ipsum available, but the majority have
											suffered alteration in some form, by injected
											randomised words which even.</p>
							...
							<div className="col-md-6 col-12 col-sm-6">
								<div className="blog-box">
									<div className="bb-img">
										<img src="assets/img/Blog/blog-img-6.png" alt="" />
										<div className="bb-img-rapper-info">
											<div className="bb date">
												<p>24 August 2019</p>
											</div>
									...
									<div className="bb-text">
										<a href="blog-details.html">
											<h2>Smiling is definitely one of the
												best beauty remedies.</h2>
										</a>
										<p>Lorem Ipsum available, but the majority have
											suffered alteration in some form, by injected
											randomised words which even.</p>
							...
							<div className="col-md-6 col-12 col-sm-6">
								<div className="blog-box">
									<div className="bb-img">
										<img src="assets/img/Blog/blog-img-7.png" alt="" />
										<div className="bb-img-rapper-info">
											<div className="bb date">
												<p>24 August 2019</p>
											</div>
									...
									<div className="bb-text">
										<a href="blog-details.html">
											<h2>Infuse your life with action
												wait for it to happen.</h2>
										</a>
										<p>Lorem Ipsum available, but the majority have
											suffered alteration in some form, by injected
											randomised words which even.</p>
							...
							<div className="col-md-6 col-12 col-sm-6">
								<div className="blog-box">
									<div className="bb-img">
										<img src="assets/img/Blog/blog-img-8.png" alt="" />
										<div className="bb-img-rapper-info">
											<div className="bb date">
												<p>24 August 2019</p>
											</div>
									...
									<div className="bb-text">
										<a href="blog-details.html">
											<h2>Good, better, best never let it
												your good is better and better.</h2>
										</a>
										<p>Lorem Ipsum available, but the majority have
											suffered alteration in some form, by injected
											randomised words which even.</p>
